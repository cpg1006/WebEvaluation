...
//
//				.antMatchers("/adminUsers/").hasAuthority(ADMIN).antMatchers("/adminEvaluations")
//				.hasAnyAuthority(EVAL_ADMIN, EVALUATOR_EVAL, EVALUATOR, ADMIN).antMatchers("/adminGroups")
...
//				.antMatchers("/home").hasAnyAuthority(ADMIN, USER, EVALUATOR, EVAL_ADMIN, EVALUATOR_EVAL)
				...
				.logoutRequestMatcher(new AntPathRequestMatcher("/logout")).logoutSuccessUrl("/logoutDone")
