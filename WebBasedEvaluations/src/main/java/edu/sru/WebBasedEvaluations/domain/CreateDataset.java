...
import edu.sru.WebBasedEvaluations.evalform.Section;
...
public class CreateDataset {
	...
	public DefaultCategoryDataset createTestDataset() {
		...
		dataset.setValue(10, "test", "test");
		dataset.setValue(5, "test 2", "test 2");
		return dataset;
	}

	/**
	 * Receives completed evaluations and generates a pie data set to be used for
	 * chart generation and PDF reports
	 * 
	 * @param completedEvals receives all completed evaluations for a specific
	 *                       reviewee
	...
	/**
	 * Receives completed evaluations and generates a category data set to be used
	 * for chart generation and PDF reports
	 * 
	 * @param completedEvals receives all completed evaluations for a specific
	 *                       reviewee
	 * @return datasetFinal data set filled with average scores of each section
	...
	/**
	 * Receives a specific completed evaluation and generates a pie data set to be
	 * used for individual chart generation and PDF reports
	 * 
	 * @param completedEvals receives specific completed evaluation for a specific
	 *                       reviewee
	...
	/**
	 * Receives a specific completed evaluation and generates a category data set to
	 * be used for individual chart generation and PDF reports
	 * 
	 * @param completedEvals receives specific completed evaluation for a specific
	 *                       reviewee
	 * @return dataset returns data set to be used in chart generation
	...
	/**
	 * Receives completed evaluations and generates a pie data set to be used for
	 * group chart generation and PDF reports
	 * 
	 * @param completedEvals receives all evaluations for a group and finds the
	 *                       average
	...
	/**
	 * Receives completed evaluation and generates a category data set to be used
	 * for group chart generation and PDF reports
	 * 
	 * @param completedEvals receives all evaluations for a group and finds the
	 *                       average
	 * @return datasetFinal returns data set to be used in chart and PDF generation
	...
	/**
	 * Receives completed self evaluation and generates a pie data set to be used
	 * for self evaluation chart generation and PDF reports
	 * 
	 * @param completedEvals receives completed self evaluation log
	 * @return data set returns a pie data set to be used in self evaluation chart
	 *         generation
	 */
